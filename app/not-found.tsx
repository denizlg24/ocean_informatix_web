    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-xl mx-auto">
          ...
          >
            <svg viewBox="0 0 240 44" fill="none" className="w-52 text-ocean-300" aria-hidden>
              <motion.path
          ...
          >
            <h2 className="font-serif text-2xl sm:text-3xl text-foreground">Lost at sea.</h2>
            <p className="text-muted-foreground leading-relaxed max-w-sm mx-auto">
              The page you&apos;re looking for has drifted off course. Let&apos;s navigate
